...
function createHelix( material, radius, tube, radialSegments, tubularSegments, height, arc, clockwise )
{
	...
	var oldTop = new THREE.Vector3(0,0,0);
	...
	for ( var i = 0; i <= arc*radialSegments ; i++ )
	{
		...
		if(oldTop.x != 0) { 
			...
			// createCapsule( material, radius, top, bottom, segmentsWidth, openTop, openBottom )

			var capsule = new createCapsule( material,
				tube,
				new THREE.Vector3(top.x,top.y,top.z),
				new THREE.Vector3(oldTop.x,oldTop.y,oldTop.z),
				64, false, false );
