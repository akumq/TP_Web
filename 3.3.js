...
function fillScene() {
	...
	cube = new THREE.Mesh(
		new THREE.BoxGeometry( 110/2, 4, 4 ).translate(110/4,0,0), minuteHandMaterial );
	cube.position.y = 14;
	...
	var sphere = new THREE.Mesh(
		new THREE.SphereGeometry( 1, 32, 16 ).translate(-1,0,0), hourHandMaterial );
    sphere.scale.x = 40;
    sphere.scale.y = 4;
    sphere.rotation.y = -60 * Math.PI / 70;
