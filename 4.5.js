...
function createDrinkingBird() {
    ...
    var bar = new THREE.Mesh( 
            new THREE.CylinderGeometry(5,5,200,32), legMaterial);
    bar.position.y = 360;
    bar.rotation.x = Math.PI*0.5
    window.scene.add(bar);

    var nose = new THREE.Mesh(
            new THREE.CylinderGeometry(14,6,70), headMaterial);
    nose.position.x = -70;
    nose.position.y = 530;
    nose.rotation.z = -Math.PI*0.5
    window.scene.add(nose);

    var eyes1 = new THREE.Mesh(
            new THREE.SphereGeometry(10,32,16), eyeMaterial);
    eyes1.position.x = -48;
    eyes1.position.y = 560;
    eyes1.position.z = -20;
    eyes1.rotation.z =  Math.PI*0.12

    window.scene.add(eyes1);

    var eyes2= new THREE.Mesh(
            new THREE.SphereGeometry(10,32,16), eyeMaterial);
    eyes2.position.x = -48;
    eyes2.position.y = 560;
    eyes2.position.z = 20;
    eyes2.rotation.z =  Math.PI*0.12

    window.scene.add(eyes2);
